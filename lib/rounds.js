  ...
  return [
    {
      ...
      answerKey: node.cardKey,
      // What a learner must have been shown for this round to be fair. The
      // play page reads it to decide where a teaching beat belongs; it means
      // nothing on its own.
      teaches: useTalkingPoints ? "notes" : "meaning",
      revealTitle: node.cardName,
      revealBody: ctx.descriptions.get(node.cardKey)?.condensed ?? "",
    },
  ];
